...
class BasicConfigForm(ConfigForm):
    ...
    site_name = forms.CharField(initial="D&D", label=_("site name"))
    site_description = forms.CharField(initial="Forums", label=_("site description"), max_length=75, required=False)
